...
[] execVM "revivePlayers.sqf"; //Was commented out, unknown as to why.
[bulwarkRoomPos] execVM "missionLoop.sqf";

[] execVM "area\areaEnforcement.sqf";
[] execVM "hostiles\clearStuck.sqf";
//[] execVM "hostiles\solidObjects.sqf"; //Commented out due to supercession by "bulwark/solidObject.sqf"
